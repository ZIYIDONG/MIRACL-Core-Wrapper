...
fn hpke_nist256() {
    ...
    let mut cipher:[u8;80]=[0;80];
    let mut tag:[u8;16]=[0;16];
    println!("\nTesting HPKE code for curve nist256");
// Mode 0
    let mut mode=0;
    println!("\nMode 0");

        decode_hex(&mut seedE,"4270e54ffd08d79d5928020af4686d8f6b7d35dbe470265f1f5aa22816ce860e");
        decode_hex(&mut seedR,"668b37171f1072f3cf12ea8a236a45df23fc13b82af3609ad1e354f6ef817550");
        
	//print!("seedE= "); printbinary(&seedE);

	hpke::deriveKeyPair(config_id,&mut skE,&mut pkE,&seedE);
	//print!("1. pkE= "); printbinary(&pkE);
...
// Mode 1
    mode=1;
    println!("\nMode 1");
    decode_hex(&mut seedE,"2afa611d8b1a7b321c761b483b6a053579afa4f767450d3ad0f84a39fda587a6");
    decode_hex(&mut seedR,"d42ef874c1913d9568c9405407c805baddaffd0898a00f1e84e154fa787b2429");
    hpke::deriveKeyPair(config_id,&mut skE,&mut pkE,&seedE);
    hpke::deriveKeyPair(config_id,&mut skR,&mut pkR,&seedR);   
...
// Mode 2
    mode=2;
    println!("\nMode 2");
    decode_hex(&mut seedE,"798d82a8d9ea19dbc7f2c6dfa54e8a6706f7cdc119db0813dacf8440ab37c857");
    decode_hex(&mut seedR,"7bc93bde8890d1fb55220e7f3b0c107ae7e6eda35ca4040bb6651284bf0747ee");
    decode_hex(&mut seedS,"874baa0dcf93595a24a45a7f042e0d22d368747daaa7e19f80a802af19204ba8");
...
// Mode 3
    mode=3;
    println!("\nMode 3");
    decode_hex(&mut seedE,"3c1fceb477ec954c8d58ef3249e4bb4c38241b5925b95f7486e4d9f1d0d35fbb");
    decode_hex(&mut seedR,"abcc2da5b3fa81d8aabd91f7f800a8ccf60ec37b1b585a5d1d1ac77f258b6cca");
    decode_hex(&mut seedS,"6262031f040a9db853edd6f91d2272596eabbc78a2ed2bd643f770ecd0f19b82");
